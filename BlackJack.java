            ...
            do {
                ...
                if (option == 1) {
                    ...
                    if (obj.player[p].PlayerCards[obj.player[p].cardNumber].getSuit() == 0) {
                        ...
                        System.out
                                .print(obj.player[p].getName() + " Card num : " + obj.player[p].cardNumber + " - Club");

                    } else if (obj.player[p].PlayerCards[obj.player[p].cardNumber].getSuit() == 1) {
                        System.out.print(
                                obj.player[p].getName() + " Card num : " + obj.player[p].cardNumber + " - Diamond");
                    } else if (obj.player[p].PlayerCards[obj.player[p].cardNumber].getSuit() == 2) {
                        System.out.print(
                                obj.player[p].getName() + " Card num : " + obj.player[p].cardNumber + " - Heart");
                    } else if (obj.player[p].PlayerCards[obj.player[p].cardNumber].getSuit() == 3) {
                        System.out.print(
                                obj.player[p].getName() + " Card num : " + obj.player[p].cardNumber + " - Spade");
                    }
